...
dados %>%
  ...
  geom_boxplot() + 
  ggtitle("Amplitude da idade do repositório") + 
...
**original: stars x age - Spearman's Rank correlation (rho = 0,0757 p < 0.001)**
```{r}
dados %>% 
...
**original: stars x commits - Spearman's Rank correlation (rho = 0,249 p < 0.001)**
```{r}
dados %>% 
